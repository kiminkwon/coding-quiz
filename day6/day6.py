...
def missinValues(arr):

    return(reduce(lambda x,y: x*y, set(map(lambda x: x*x if arr.count(x)==1 else x if arr.count(x)==2 else 1 , arr))))


a= [1, 1, 1, 2, 2, 3]
b=[6, 5, 4, 100, 6, 5, 4, 100, 6, 5, 4, 200]
print(missinValues(a))
print(missinValues(b))